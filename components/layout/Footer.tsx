            ...
            <div className="mt-5 flex items-center gap-3">
              {FOOTER_SOCIAL_LINKS.map(({ icon: Icon, label }) => (
                <Link
                  ...
                  href="#"
                  aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-border/10 text-foreground/60 transition-colors hover:border-border/25 hover:text-foreground"
                >
