...
**Live deployment:** https://codehurdle-assignment.vercel.app/
...
components/
  layout/
    Header.tsx         Sticky nav, responsive mobile menu, Dark/Light mode
...
1. Wire the CTA buttons to a real signup flow.
2. Add a lightweight analytics hook on primary CTA clicks to measure conversion by
